...
//////////////Athom/////////////////
  ...
  // #else
  //   server.on("/getflash", HTTP_GET, [](AsyncWebServerRequest *request){
  //     request->send(200, "text/plain", (String)ESP.getFlashChipRealSize());
  //   });  
  // #endif
  server.on("/buildtime", HTTP_GET, [](AsyncWebServerRequest *request){
    request->send(200, "text/plain", (String)GetBuildDateAndTime());
  });
///////////end//////////////
